...
public class CustomerController {
    ...
    private final CustomerRepository customerRepository;   // ✅ MISSING FIX
    ...
    public String loginCustomer(@ModelAttribute("customer") Customer formCustomer,
                                Model model, HttpSession session) {

        Customer customer = customerRepository.findByUsername(formCustomer.getUsername());

        if (customer == null || 
            !passwordEncoder.matches(formCustomer.getPassword(), customer.getPassword())) {
    ...
    // ----- DEPOSIT GET -----
    @GetMapping("/deposit")
    public String showDeposit(HttpSession session) {
